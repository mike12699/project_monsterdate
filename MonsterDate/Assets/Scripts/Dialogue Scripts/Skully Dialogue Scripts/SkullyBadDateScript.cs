...
public class SkullyBadDateScript : MonoBehaviour
{
    ...
    public void BadDateStart()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Annoyed/(And he's... just as annoying as I thought he was! Great. Glad that this is my fate right now.)", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup1/Uh... Sure! Yeah, they sure did! Had a good time at dinner, yes, sir!", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Annoyed/(Gods, lets hope he gets better at... /wait:0.5/not doing that.)", "Skully"));
    ...
    {
        SceneManager.LoadScene("SkullyBadNeutralPuzzle");
    }
}
