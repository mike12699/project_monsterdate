...
public class SkullyGoodEpilogueScript : MonoBehaviour
{
    ...
    public void GoodEpilogueEnd()
    {
        ...
        var endText = new DialogData("/speed:0.03//emote:Smile/At first, he thought to simply promote me to his majordomo, but after a lengthy romance, I eventually got my real promotion — husband.", "Skully");
