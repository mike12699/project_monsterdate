...
public class SkullyGoodDateScript : MonoBehaviour
{
    ...
    public void GoodDateStart()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/(Shit... Not me thinkin' the boss is a little—)", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup1/Uh... Y-yeah, I guess so, boss. Er, uh— Askarios!", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Confused/WHAT IS WRONG, SKULLY? THOU SEEMEST DISTRACTED!", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smile/I-it's just the food coma settlin' in! Don't worry about it too much!", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smile/Uh... Y-yeah, rest well, boss!", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/(Fuck... This ain't good.)", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smug/[Skully crosses his arms and smirks.]", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smug/Where are ya takin' me?", "Skully"));
    ...
    public void GoodDateContinue()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup1/Oh, uh... No, no, nothing's wrong.", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/We... kinda just lived in fear of starvation and massacre, seeing how your army liked to stage its conquest, so... /wait:0.5/yeah.", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/Thought I'd be free from all that when the life had finally left my body. Guess not, though.", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/So, when you brought me back, I didn't go straight to your service — I'm sure ya remember that.", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/I was left to wander around and see how the world had changed after the slaughter, and I spent quite a bit of time mourning the remains of my parents and sisters.", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/This is all your doing, Askarios. I hope you fuckin' know that.", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Blush/...", "Askarios"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smile/[Skully lets out a content sigh, then leans onto Askarios, closing his eyes.]", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smile/It sure is, Askarios. It sure is.", "Skully"));
