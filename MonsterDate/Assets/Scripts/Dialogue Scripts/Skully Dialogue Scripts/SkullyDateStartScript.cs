...
public class SkullyDateStartScript : MonoBehaviour
{
    ...
    public void DateStart()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smug/Where are ya takin' me, then?", "Skully"));
    ...
    public void DateContinue()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Annoyed/(Do you... even have taste buds anymore?)", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/...partners.", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Annoyed/Skully, boss.", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smug/[He smirks his best lipless smirk.]", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smug/Got that... /wait:0.5/Askarios?", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Annoyed/[There is a long, awkward pause out of Skully.]", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup1/Well, count me flattered, Askarios.", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Laugh/[He lets out a nervous chuckle.]", "Skully"));
