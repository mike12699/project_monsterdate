...
public class EyevanBadEpilogueScript : MonoBehaviour
{
    ...
    public void BadEpilogueEnd()
    {
        ...
        var endText = new DialogData("/speed:0.03//emote:Sad/In the coming months, an army of death and blood encroached on the horizon of Zyx, led by none other than Eyevan himself, with the soldiers bearing a familiar mark — the crest of Skentira", "Skully");
