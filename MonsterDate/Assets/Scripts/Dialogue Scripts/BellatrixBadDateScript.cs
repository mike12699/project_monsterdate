...
public class BellatrixBadDateScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/WELL, I DO BELIEVE THAT SHE ENJOYED OUR CONVERSATION, HMM, MINION? HER MANY EYES WERE FOCUSED ON ME FOR SO VERY LONG, SO I AM ALL BUT CERTAIN OF HER ENTHRALLMENT!", "Askarios"));
