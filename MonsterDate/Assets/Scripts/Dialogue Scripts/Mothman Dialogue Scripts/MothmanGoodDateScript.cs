...
public class MothmanGoodDateScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/(Note to self: Don't let the boss smoke.)", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/Right... Well, anyway, it looks like ya got on his good side, so that's exciting, right?", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/(Assuming Greg can remember to call you through... all that.)", "Skully"));
