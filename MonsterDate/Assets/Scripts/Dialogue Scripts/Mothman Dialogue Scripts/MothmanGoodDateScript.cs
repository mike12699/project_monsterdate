...
public class MothmanGoodDateScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/[After a moment of consideration, he perks up from the idea coming back to him, then gestures his joint towards Askarios,", "Mothman"));
        dialogueTexts.Add(new DialogData("/speed:0.03//sound:mothman_longhit/lightly tapping ashes onto the floor before taking an extended hit, which he exhales for just as long.]", "Mothman"));   
