...
public class MothmanGoodDateScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/MINION! MY CONVERSATION WITH GREGORY WAS MOST ENLIGHTENING, WOULD YOU NOT AGREE?", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03/Ya think he enjoyed your philosophical talk, boss?", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/(Whatever your philosophy is, that is.)", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/HE SEEMED POSITIVELY DELIGHTED TO INDULGE HIMSELF IN THE ALLURE OF MY WORDS!", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03/OUR DISCUSSION OF THE NATURE OF TERRORIZING MAN FROM ON HIGH WAS ILLUMINATING, BOTH IN WHERE I COULD STRENGTHEN MY CONQUESTS AND IN WHAT MANNER HE COULD REFINE HIS OMINOUS APPROACHES!", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03/How'd, uh... the glimmerroot affect that conversation?" ,"Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/MY MIND WAS OPENED TO POSSIBILITIES EVEN I HAD NOT CONSIDERED REASONABLE! 'TWAS AS IF A VEIL WAS REMOVED, ALLOWING THE KNOWLEDGE OF THE COSMOS TO POUR IN!", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03/How, uh... long's it been since you last smoked, boss?", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/...LIKELY DECADES, IF I AM BEING UTTERLY HONESTLY.", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Sad/(Note to self: Don't let the boss smoke.)", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup2/Right... Well, anyway, it looks like ya got on his good side, so that's exciting, right?", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03/ABSOLUTELY! I LOOK FORWARD TO OUR NEXT MEET, WHENEVER IT SHALT BE!", "Askarios"));
        dialogueTexts.Add(new DialogData("/speed:0.03/Guess we'll have to wait and find out.", "Skully"));
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Thumbsup1/(Assuming Greg can remember to call you through... all that.)", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//sound:mothman_knock/[There's a lazy knock at the door.]", "Narrator"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//sound:askarios_rundoorswing/[Askarios runs over and throws the door open with far too much force, nearly breaking the hinge in the process.]", "Narrator"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//sound:mothman_sitonbed/Been a minute since we saw each other last, but I had to tell you somethin', and soon.", "Mothman"));
        dialogueTexts.Add(new DialogData("/speed:0.03//sound:askarios_cloakwipe/[Askarios turns, then retreats back into the room, idly wiping the residue off of his clothes. The smoke seems to be teasing his senses.]", "Narrator"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Closed/[He chuckles, then lazily gestures around, emphasizing his point, punctuated with a long sip of his martini.]", "Mothman"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Smile//sound:mothman_blinks/[Skully blinks.]", "Skully"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/[After a moment of consideration, he perks up from the idea coming back to him, then gestures his joint towards Askarios, /wait:0.5//sound:mothman_longhit/lightly tapping ashes onto the floor before taking an extended hit, which he exhales for just as long.]", "Mothman"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Closed/[He coughs.]", "Mothman"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03//emote:Closed/[He chuckles again.]", "Mothman"));
    ...
    {
        SceneManager.LoadScene("MothManGoodNeutralPuzzle");
    }
}
