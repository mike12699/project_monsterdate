...
public class BellatrixBadEpilogueScript : MonoBehaviour
{
    ...
    public void BadEpilogueStart()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/He found himself on a number of dates with each, [many of which/some of which/none of which] were successful, and in time, his search would come to an end.", "Skully"));
