...
public class BellatrixGoodDateScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/I DO SAY, THAT FIRST ENCOUNTER WAS QUITE DELIGHTFUL, WOULD YOU NOT SAY, MINION? MY SPEECH ON THE INTRICACIES OF BONE FRACTURES SEEMED POSITIVELY ENTHRALLING TO HER!", "Askarios"));
        ...
        dialogueTexts.Add(new DialogData("/speed:0.03/THINE PASSION IS APPARENT, BELLATRIX! PRAY, TELL ME OF YOUR CONCERT, FOR I AM UNFORTUNATELY UNAWARE OF SUCH AN EVENT!", "Bellatrix"));
        ...
        var Confirm = new DialogData("/speed:0.03/Sure thing, sir.", "NPC");
        Confirm.SelectList.Add("Confirm", "Proceed to minigame");

        Confirm.Callback = () => LoadBellatrixMatch3Pt2();
    ...
    void LoadBellatrixMatch3Pt2()
    {
        ...
        {
            SceneManager.LoadScene("BugGirlPuzzlePt2");
        }
    }
}
