...
public class Grid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //SpawnNewPiece(4, 4, PieceType.TRASH);
    ...
    public List<GamePiece> GetMatch(GamePiece piece, int newX, int newY)
    {
        if (piece.IsColored())
        {
            ...
            //First checks horizontal pieces to see if they match.
            ...
            //Looks for matches that are L or T shaped.
            if (horizontalPieces.Count >= 3)
            {
                for (int i = 0; i < horizontalPieces.Count; i++)
                {
            ...
            //Checks vertical pieces to see if they match.
            ...
            //Looks for L or T shapes when matching vertically.
            if (verticalPieces.Count >= 3)
            {
                for (int i = 0; i < verticalPieces.Count; i++)
                {
    ...
    public void ClearObstacles(int x, int y)
    {
        for (int adjacentX = x - 1; adjacentX <= x + 1; adjacentX++)
        {
            ...
            {
                if (pieces[adjacentX, y].Type == PieceType.TRASH && pieces[adjacentX, y].IsClearable())
                {
        ...
        for (int adjacentY = y - 1; adjacentY <= y + 1; adjacentY++)
        {
            ...
            {
                if (pieces[x, adjacentY].Type == PieceType.TRASH && pieces[x, adjacentY].IsClearable())
                {
